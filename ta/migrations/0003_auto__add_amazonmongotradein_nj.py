...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AmazonMongoTradeIn_NJ'
        db.create_table(u'ta_amazonmongotradein_nj', (
        ...
        db.send_create_signal(u'ta', ['AmazonMongoTradeIn_NJ'])


    def backwards(self, orm):
        # Deleting model 'AmazonMongoTradeIn_NJ'
        db.delete_table(u'ta_amazonmongotradein_nj')
    ...
    models = {
        ...
        u'ta.amazonmongotradein_nj': {
            'Meta': {'object_name': 'AmazonMongoTradeIn_NJ'},
